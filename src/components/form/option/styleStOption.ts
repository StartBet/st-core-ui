...
export const buildOptionClasses = (props: OptionClassProps) => {
  ...
  const option = [
    'relative m-0 flex cursor-pointer appearance-none items-center justify-start gap-st-1 overflow-hidden rounded-st-1 border-0 p-st-1 text-left font-st-body text-st-body-small text-st-content-default select-none',
    'transition-colors duration-200 ease-in-out',
    selected
      ? 'bg-st-surface-1 hover:bg-st-surface-2 active:bg-st-surface-1'
      : 'hover:bg-st-surface-2 active:bg-st-surface-1',
